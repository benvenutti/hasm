...
Hack::WORD Coder::dest(const std::string& mnemonic) {
  ...
  if (mnemonic.find('A') != std::string::npos) dest |= 0b100;
...
Hack::WORD Coder::comp(const std::string& mnemonic) {
  ...
  else if (m == "-1") comp = 0b111010;
  else if (m == "D") comp = 0b001100;
  else if (m == "A") comp = 0b110000;
  else if (m == "!D") comp = 0b001101;
  else if (m == "!A") comp = 0b110001;
  else if (m == "-D") comp = 0b001111;
  else if (m == "-A") comp = 0b110011;
  else if (m == "D+1") comp = 0b011111;
  else if (m == "A+1") comp = 0b110111;
  else if (m == "D-1") comp = 0b001110;
  else if (m == "A-1") comp = 0b110010;
  else if (m == "D+A") comp = 0b000010;
  else if (m == "A+D") comp = 0b000010;
  else if (m == "D-A") comp = 0b010011;
  else if (m == "A-D") comp = 0b000111;
